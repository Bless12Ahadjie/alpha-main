...
const Signin = () => {
  return (
    ...
    <div className={styles.wrapper}>
        ...
        <div>
                <p className={styles.Header}>Sign in to Alpha</p>
                <p className={styles.subTxt}>Don't have an account? <Link to='/register' className={styles.span}>Sign Up</Link></p>
            </div>
    
            <div className={styles.googleSignup}>
            <svg className= {styles.GmailLogo}cls xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <Link className={styles.gmailTxt}>Sign in with Gmail</Link>
            </div>
